...
from fastapi.security.http import HTTPAuthorizationCredentials # a special class to allow us to get protect an endpoint & make it only access when someone provides their token in the form of Bearer
