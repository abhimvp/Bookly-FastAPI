...
# app = FastAPI()
# # this is going to be our FASTAPI Instance or object , with this app , we can pretty much get access
...
# app.include_router(book_router) # this is how we can include books API endpoints 
